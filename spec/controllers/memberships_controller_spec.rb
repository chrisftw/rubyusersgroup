  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested membership" do
        ...
        Membership.any_instance.should_receive(:update_attributes).with({ "user_id" => "MyString" })
        put :update, {:id => membership.to_param, :membership => { "user_id" => "MyString" }}, valid_session
      end
